...
DEFAULT_INDEX_DIR = "/Users/vladimirdeziegler/text_crewai/Vladoesgrowth/ContractReview/src/policy recommendation/utils/insurance_index"
...
class DocumentQueryTool(BaseTool):
    ...
    name: str = "DocumentQueryTool"
    description: str = """Useful for querying information from insurance claim documents. 
    You can ask questions about claim details, policy information, damages reported, 
    settlement amounts, and other information contained in insurance documents."""
...
if __name__ == "__main__":
    ...
    for test_query in test_queries:
        ...
        try:
            ...
            print(f"\nSOURCE TEXT PREVIEW: {result_dict['source_text'][:200]}...")
        except:
